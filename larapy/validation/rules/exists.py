"""Exists validation rule for database checks"""
...
class ExistsRule(BaseRule):
    ...
    def __init__(self, table: str, column: str = None, connection: str = None):
        ...
        # Additional constraints for complex exists rules
    ...
    def passes(self, attribute: str, value: Any, parameters: Optional[List[str]] = None) -> bool:
        ...
        try:
            return self._query_database(value)
    ...
    def _try_alternative_database_access(self, value: Any) -> bool:
        ...
        try:
            ...
            # For now, we'll return True to not break validation when DB is not configured
            return True

    def where(self, column: str, operator_or_value, value=None):
        """Add a where clause to the exists query"""
        if value is None:
    ...
    def where_not(self, column: str, operator_or_value, value=None):
        """Add a where not clause to the exists query"""
        if value is None:
    ...
    def __str__(self) -> str:
        ...
        return f"exists:{self.table},{self.column}"